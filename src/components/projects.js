        ...
        if(this.state.activeTab === 0){
            return(
                ...
                <div className = "projects-grid">
                    <Grid>
                        <Cell col = {4}>
                            <Card className ="cardmain" shadow = {5} style ={{ minWidth :'300', padding : '10px'}}>
                        ...
                        <Cell col = {4}>
                            <Card shadow = {5} style ={{ minWidth :'300', padding : '10px'}}>
                                ...
                                <CardText>A network for sending/ receiving anonymous reviews.</CardText>
                                <CardActions border>
