...
class projects extends Component {
    ...
    toggleCatagories(){
        ...
        if(this.state.activeTab === 2){
            return(
                <Card className ="cardmain" shadow = {5} style ={{ minWidth :'450', margin : 'auto'}}>
                    ...
                    <Grid>
                        <Cell col = {4}>
                            <Card  className ="cardmain" shadow = {5} style ={{ minWidth :'300'}}>
                                <CardTitle   style = {{color: '#fff',height:'176px', background: `url(${require('../images/pixelator.PNG')}) center/cover`}}></CardTitle>
                                <CardText><h5 style = {{margin:'0', marginBottom:'5px'}}>Pixelator</h5>A webapp to pixelate your favourite computer graphics.</CardText>
                                <CardActions border>
                        ...
                        <Cell col = {4}>
                            <Card className ="cardmain" shadow = {5} style ={{ minWidth :'300'}}>
                                <CardTitle  style = {{color: '#fff',height:'176px', background: `url(${require('../images/anonymousreview.PNG')}) center/cover`}}></CardTitle>
